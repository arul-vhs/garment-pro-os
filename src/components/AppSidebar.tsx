...
import {
  ...
  Coins, MessageCircle, ShieldCheck, GitBranch, CreditCard, Globe, FileClock, FileText, SlidersHorizontal,
} from "lucide-react";
import {
...
const systemItems = [
  ...
  { key: "nav.tenantSettings", url: "/tenant-settings", icon: SlidersHorizontal },
