...
export const ROLE_ROUTES: Record<Role, string[]> = {
  ...
  receptionist: ["/", "/customers", "/measurements", "/orders", "/billing", "/communications", "/notifications", "/settings", "/organization", "/onboarding", "/reports-center"],
  tailor: ["/", "/orders", "/production", "/notifications", "/settings", "/organization", "/onboarding"],
  inventory: ["/", "/inventory", "/reports", "/reports-center", "/branches", "/notifications", "/settings", "/organization", "/onboarding"],
};
